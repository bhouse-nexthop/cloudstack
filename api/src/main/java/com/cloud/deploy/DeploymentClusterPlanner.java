...
public interface DeploymentClusterPlanner extends DeploymentPlanner {
    ...
    static final ConfigKey<String> VmAllocationAlgorithm = new ConfigKey<>(
            ...
            "Order in which hosts within a cluster will be considered for VM allocation. The value can be 'random', "
                    + "'firstfit', 'userdispersing', 'userconcentratedpod_random', 'userconcentratedpod_firstfit', "
                    + "'firstfitleastconsumed', or 'balancedweighted'. 'balancedweighted' ranks hosts on a blend of "
                    + "allocated capacity, measured utilisation, VM count and how many VMs started recently, and is "
                    + "tuned with the host.weighted.* settings.",
            true,
            ConfigKey.Scope.Global, null, null, null, null, null,
            ConfigKey.Kind.Select,
            "random,firstfit,userdispersing,userconcentratedpod_random,userconcentratedpod_firstfit,firstfitleastconsumed,balancedweighted");
